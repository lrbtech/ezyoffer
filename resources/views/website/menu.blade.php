                        ...
                        <div class="collapse navbar-collapse ps-navigation" id="navbarNav">
                            <ul class="navbar-nav nav-Js ml-auto ps-nav ps-nav__ul">
                                <li class="ps-menuhover menu-item-has-children page_item_has_children">
                                    <a href="javascript:void(0);" class="ps-header__line">About <i class="fas fa-chevron-down"></i></a>
                                    <ul class="sub-menu ps-dropdown ps-first__dropdown">
                                        <li class="nav-item"><a href="index.html">How it works</a></li>
                                        <li class="dropdown-divider"></li>
                                        <li class="nav-item"><a href="index-v2.html">Our story</a></li> 
                                        <li class="dropdown-divider"></li>
                                        <li class="nav-item"><a href="index-v2.html">Careers</a></li> 
                                        <li class="dropdown-divider"></li>
                                        <li class="nav-item"><a href="index-v2.html">Auto dealerships</a></li> 
                                        <li class="dropdown-divider"></li>
                                        <li class="nav-item"><a href="index-v2.html">Trust & safety</a></li> 
                                        <li class="dropdown-divider"></li>
                                        <li class="nav-item"><a href="index-v2.html">Terms</a></li> 
                                        <li class="dropdown-divider"></li>
                                        <li class="nav-item"><a href="index-v2.html">Community</a></li> 
                                        <li class="dropdown-divider"></li>
                                        <li class="nav-item"><a href="index-v2.html">Blog</a></li> 
                                        <li class="dropdown-divider"></li>
                                        <li class="nav-item"><a href="index-v2.html">Press</a></li> 
                                        <li class="dropdown-divider"></li>
                                        <li class="nav-item"><a href="index-v2.html">Help</a></li> 
                                        <li class="dropdown-divider"></li>
                                        <li class="nav-item"><a href="index-v2.html">Privacy</a></li> 
                            ...
                            <ul class="navbar-nav ps-nav">
                                ...
                                <li class="nav-item dropdown ps-menuhover ps-userlogo">
                                    ...
                                    <ul class="dropdown-menu ps-dropdown ps-user__dropdown position-absolute" aria-labelledby="navbarDropdown4">
                                        <li class="nav-item"><a class="dropdown-item" href="/customer/dashoard"><i class="ti-dashboard"></i>Dashboard</a></li>                             
                                        <li class="dropdown-divider"></li>

            ...
            <div class="row ps-uniqueGadgets ps-gridList ps-main-section">
                ...
                <div class="col-md-5 col-lg-4 col-xl-3">
                    ...
                    <div class="ps-gridList__searchArea ps-gridList__priceRange">
                        ...
                        <div id="slider-range" class="ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"><div class="ui-slider-range ui-corner-all ui-widget-header" style="left: 24%; width: 52%;"></div><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 24%;"></span><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 76%;"></span></div>
                    </div>
                    <div class="ps-gridList__searchArea ps-gridList__categories">
                        <h6>Condition</h6>
                        <div class="ps-gridList__checkbox">
                    ...
                    <div class="ps-gridList__searchArea ps-gridList__priceRange ps-gridList__areaUnit">
                        ...
                        <form class="ps-form">
                            <div class="ps-select ps-sort">
                                <select class="chosen-select locations form-control" data-placeholder="Country" name="locations" style="display: none;">
                                ...
                                </select><div class="chosen-container chosen-container-single" title="" style="width: 213px;"><a class="chosen-single">
  <span>Area Unit</span>
  <div><b></b></div>
</a>
...
<div class="chosen-drop">
  ...
  <ul class="chosen-results"></ul>
                        ...
                        <div id="slider-rangeTwo" class="ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"><div class="ui-slider-range ui-corner-all ui-widget-header" style="left: 24%; width: 52%;"></div><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 24%;"></span><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 76%;"></span></div>
                    </div>
                    ...
                    <div class="ps-gridList__searchArea ps-gridList__priceRange">
                        ...
                        <div id="slider-rangeThree" class="ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"><div class="ui-slider-range ui-corner-all ui-widget-header" style="left: 30%; width: 42.5%;"></div><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 30%;"></span><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 72.5%;"></span></div>
                    </div>
                    <div class="ps-gridList__searchArea ps-gridList__priceRange ps-gridList__areaUnit">
                        <h6>Misc</h6>
                        <form class="ps-form">
                            ...
                            <a href="/details">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h6>AED1,149</h6>
                                        <p class="card-text">Brand New Touch Book For Sale</p>
                                        <span class="d-block"><i class="ti-layers"></i> <a href="/details">Electronics</a></span>
                                        <span><i class="ti-time"></i> <span>Jun 27, 2019</span></span>
                                        <figure><img src="images/user-icon/img-04.jpg" alt="Image Description"></figure>
                                    </div>
                                    <ul class="list-group">
                                        <li class="list-group-item"><span><i class="ti-map"></i> <a href="/details">Manchester, UK</a></span><a href="javascript:void(0);"><i class="far fa-heart"></i></a></li>
                                    </ul>
                                </div>
                            </a>
                        </div>

         ...
         <section class="page-title style-two" style="background-image: url(/assets/images/background/page-title.jpg);">
            <div class="auto-container">
               <div class="content-box centred mr-0">
                  <div class="title">
                     <h1>{{$language[214][session()->get('lang')]}}</h1>
                  </div>
                  <ul class="bread-crumb clearfix">
                     <li><a class="translate" href="/">Home</a></li>
                     <li>{{$language[214][session()->get('lang')]}}</li>
                  </ul>
               </div>
            </div>
         </section>
               ...
               <div class="row clearfix">
                  ...
                  <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                     ...
                     {{csrf_field()}}
                        <div class="box-section">
                           <div class="section-single">
                              <div class="form-group">
                                 ...
                                 <input name="title" id="title" type="text" class="form-control" placeholder="{{$language[216][session()->get('lang')]}}">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="number" class="form-control" id="price" name="price" required="" placeholder="{{$language[224][session()->get('lang')]}}">
                              </div>
                              <div class="form-group ps-fullwidth">
                                 <label class="col-form-label">{{$language[225][session()->get('lang')]}}</label>
                                 <textarea name="description" id="description" class="form-control" placeholder="{{$language[226][session()->get('lang')]}}*" spellcheck="false"></textarea>
                              </div>
                              <!-- <div class="form-group">
                           ...
                           <div class="section-single">
                              <ul class="ps-profile-setting__imgs ps-add-feature__content ps-item-mesonry row form-group-new">
                                 <li class="ps-feature-select col-md-6 ps-ms-item">
                                    ...
                                    <input value="Free" id="item_conditions5" type="radio" name="item_conditions">
                                    <span>Free</span>
                                    </label>                                    
                                 </li>
                              </ul>
                        ...
                        <button id="save" onclick="Save()" class="theme-btn-one">{{$language[235][session()->get('lang')]}}</button>
                     </form>
                  </div>
               </div>
            </div>

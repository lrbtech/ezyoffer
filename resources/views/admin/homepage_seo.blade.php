    ...
    <div class="page-header">
      <div class="row">
        <div class="col-lg-6 main-header">
          <h2>{{$language[116][Auth::guard('admin')->user()->lang]}}</h2>
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                  <div class="form-group">
                    <label class="form-label">{{$language[117][Auth::guard('admin')->user()->lang]}}</label>
                ...
                <div class="col-sm-12 col-md-12">
                  <div class="form-group">
                    <label class="form-label">{{$language[118][Auth::guard('admin')->user()->lang]}}</label>
                ...
                <div class="col-sm-12 col-md-12">
                  <div class="form-group">
                    <label class="form-label">{{$language[119][Auth::guard('admin')->user()->lang]}}</label>

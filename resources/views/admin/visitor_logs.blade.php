            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  <h2>{{$language[76][Auth::guard('admin')->user()->lang]}}</h2> 
                      ...
                      <table class="display" id="datatable">
                        <thead>
                          <tr>
                            ...
                            <th>{{$language[79][Auth::guard('admin')->user()->lang]}}</th>
                            <th>{{$language[80][Auth::guard('admin')->user()->lang]}}</th>
                            <th>{{$language[81][Auth::guard('admin')->user()->lang]}}</th>
                          </tr>
                        </thead>
                        <tbody>

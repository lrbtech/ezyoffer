            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  <h2>Package  <span>Report  </span></h2> 
                ...
                <form target="_blank" action="#" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card-header">
                      <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            <button style="margin-top:30px;" id="search" class="btn btn-primary btn-block mr-10" type="button">Search</button>
                        </div>
                      </div>
...
function search_url(){
  ...
  return '/admin/get-package-report/'+fdate+'/'+tdate+'/'+package_id;
}

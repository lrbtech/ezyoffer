            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  <h2>{{$language[60][Auth::guard('admin')->user()->lang]}}</h2>
                  ...
                  {{ csrf_field() }}
                    <div class="card-header">
                      <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            <button id="search" class="btn btn-primary btn-block mr-10" type="button">{{$language[59][Auth::guard('admin')->user()->lang]}}</button>
                        </div>
                      </div>
                    </div>
                  </form>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="datatable">
                        <thead>
                          <tr>
                            <th>{{$language[61][Auth::guard('admin')->user()->lang]}}</th>
                            <th>{{$language[62][Auth::guard('admin')->user()->lang]}}</th>
                            ...
                            <th>{{$language[67][Auth::guard('admin')->user()->lang]}}</th>

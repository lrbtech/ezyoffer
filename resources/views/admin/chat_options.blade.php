            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  <h2>{{$language[113][Auth::guard('admin')->user()->lang]}}</h2>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <span>{{$language[114][Auth::guard('admin')->user()->lang]}}</span>
                    </button>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="basic-1">
                        ...
                        <tbody>
                        @foreach($chat_options as $key => $row)
                        <tr>
                            <td>{{$key + 1}}</td>
                            <td>{{$row->message}}</td>
                            <td>
...
function Edit(id){
  $.ajax({
    url : '/admin/edit-chat-options/'+id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
      $('#modal-title').text('Update chat-options');
...
function Delete(id,status){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/delete-chat-options/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

<!DOCTYPE html>
  ...
  <head>
    ...
    <title>Ezyoffer Admin Dashboard</title>
    <!-- Google font-->
      ...
      <div class="page-main-header">
        <div class="main-header-right">
          <div class="main-header-left text-center">
            <div class="logo-wrapper"><a href="/admin/dashboard"><img style="height:70px;" src="/upload_files/{{$settings->logo}}" alt=""></a></div>
          </div>
        ...
        <div class="iconsidebar-menu">
          <div class="sidebar">
            <ul class="iconMenu-bar custom-scrollbar">
              ...
              <li>
                <a class="bar-icons" href="javascript:void(0)"><i class="pe-7s-id"></i><span>{{$language[3][Auth::guard('admin')->user()->lang]}}</span></a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">{{$language[3][Auth::guard('admin')->user()->lang]}}</li>
                  <li class="post-ads"><a class="post-ads" href="/admin/post-ads">{{$language[4][Auth::guard('admin')->user()->lang]}}</a></li>
                  <li class="report-post-ads"><a class="report-post-ads" href="/admin/report-post-ads">{{$language[5][Auth::guard('admin')->user()->lang]}}</a></li>
                </ul>
              </li>

              <li>
                <a class="bar-icons" href="/admin/chat-customer"><i style="font-size:22px; vertical-align:middle;color:#242934;font-weight:600;" data-feather="message-circle"></i><span>{{$language[6][Auth::guard('admin')->user()->lang]}}</span></a>
              </li>

              <li>
                <a class="bar-icons" href="/admin/stores"><i class="pe-7s-id"></i><span>{{$language[7][Auth::guard('admin')->user()->lang]}}</span></a>
              </li>
            
              <li>              
                <a class="bar-icons" href="javascript:void(0)"><i class="pe-7s-graph3"></i><span>{{$language[8][Auth::guard('admin')->user()->lang]}} </span></a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">{{$language[8][Auth::guard('admin')->user()->lang]}}</li>

                  <!-- <li class="package-summary"><a class="package-summary" href="/admin/package-summary">Package Summary </a></li> 

                  <li class="package-report"><a class="package-report" href="/admin/package-report">Package Report </a></li>  -->

                  <li class="visitor-logs"><a class="visitor-logs" href="/admin/visitor-logs">{{$language[9][Auth::guard('admin')->user()->lang]}} </a></li> 
                  
                </ul>
              </li>

              <li>
                <a class="bar-icons" href="javascript:void(0)"><i class="pe-7s-config"></i><span>{{$language[10][Auth::guard('admin')->user()->lang]}}</span></a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">{{$language[10][Auth::guard('admin')->user()->lang]}}</li>
                  ...
                  <li class="city"><a class="city" href="/admin/city">{{$language[13][Auth::guard('admin')->user()->lang]}}</a></li>
                  ...
                  <li class="languages"><a class="languages" href="/admin/languages">{{$language[17][Auth::guard('admin')->user()->lang]}}</a></li>

                </ul>
              </li>

              <li>
                <a class="bar-icons" href="javascript:void(0)"><i class="pe-7s-config"></i><span>{{$language[18][Auth::guard('admin')->user()->lang]}}</span></a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                  ...
                  <li class="terms-and-conditions"><a class="terms-and-conditions" href="/admin/terms-and-conditions">{{$language[19][Auth::guard('admin')->user()->lang]}}</a></li>

                  <li class="how-it-works"><a class="how-it-works" href="/admin/how-it-works">{{$language[20][Auth::guard('admin')->user()->lang]}}</a></li>
                  ...
                  <li class="auto-dealerships"><a class="auto-dealerships" href="/admin/auto-dealerships">{{$language[22][Auth::guard('admin')->user()->lang]}}</a></li>

                  <li class="trust-saftey"><a class="trust-saftey" href="/admin/trust-saftey">{{$language[23][Auth::guard('admin')->user()->lang]}}</a></li>

                  <li class="community"><a class="community" href="/admin/community">{{$language[24][Auth::guard('admin')->user()->lang]}}</a></li>
                  ...
                  <li class="blog"><a class="blog" href="/admin/blog">{{$language[25][Auth::guard('admin')->user()->lang]}}</a></li>
